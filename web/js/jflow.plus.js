...
function changeActiveButton () {
  $(jFB).removeClass('jFlowActive');
  $(jFB).eq(cur).addClass('jFlowActive');
}

                $(jFB).click(function(x){
                    var index = $(jFB).index(this);
                    $(jFB).removeClass('jFlowActive');
                    $(this).addClass('jFlowActive');
                    $(jFC).removeClass(jSel);
                    slide(1,index);
                    $(jFC).eq(index).addClass(jSel);
		});
