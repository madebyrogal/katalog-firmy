...
<?php if (count($categories)): ?>
  <ul>
    ...
    <li class="node cms_menu_maincategory <?php echo isset($category['cms_part']) ? 'cms_part_'.$category['cms_part'] : ''; ?>"><a href="#"><?php echo isset($category['name']) ? __($category['name']) : __($name) ?></a>
      <ul>
