...
/**
 * FilesTranslation filter form base class.
 *
 * @package    sell4
 * @subpackage filter
 ...
 */
abstract class BaseFilesTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('files_translation_filters[%s]');
