...
/**
 * GalleriesTranslation filter form base class.
 *
 * @package    sell4
 * @subpackage filter
 ...
 */
abstract class BaseGalleriesTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galleries_translation_filters[%s]');
