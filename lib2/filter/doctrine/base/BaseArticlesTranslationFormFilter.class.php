...
/**
 * ArticlesTranslation filter form base class.
 *
 * @package    sell4
 * @subpackage filter
 ...
 */
abstract class BaseArticlesTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('articles_translation_filters[%s]');
